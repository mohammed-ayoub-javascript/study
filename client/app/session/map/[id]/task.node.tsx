...
export default function TaskNode({ data } : any) {
  return (
    <div className={`min-w-[150px] p-3 rounded-lg border-2 transition-all ${
      data.isCompleted 
      ...
      <div className="text-center">
        ...
        <button 
          ...
          className={`mt-2 text-[9px] px-2 py-1 rounded ${
            data.isCompleted ? 'bg-emerald-500 text-white' : 'bg-stone-800 text-orange-500 border border-orange-900'
          }`}
        >
